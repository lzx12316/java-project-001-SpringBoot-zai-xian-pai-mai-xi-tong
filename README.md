# java-project-001-SpringBoot-zai-xian-pai-mai-xi-tong

> 🎓 **Java 毕业设计源码分享** | 适合计算机相关专业毕业设计、课程设计参考学习

## 📌 项目简介

本项目是 **在线拍卖**，采用主流 Java Web 技术栈开发，功能完整、结构清晰，非常适合作为毕业设计或课程设计的参考源码。

**原始项目名**：`springboot001基于SpringBoot的在线拍卖系统`
